...
public class MoflonCoreUiActivator extends AbstractUIPlugin {
	 ...
	 *
	 * The {@link #start(BundleContext)} method has to be called prior to invoking
	 * this method
	 *
	 * @return
	 */
	...
	/**
	 * Initialize log and configuration file. Configuration file is created with
	 * default contents if necessary. Log4J is setup properly and configured with a
	 * console and logfile appender.
	 */
	...
	/**
	 * Call to ensure that log4j is setup properly and configured. Can be called
	 * multiple times. Forces Plugin to be loaded and started, ensuring that log
	 * file and config file exist.
	 */
	...
	/**
	 * Used when the plugin has to store resources on the client machine and eclipse
	 * installation + current workspace. This location reserved for the plugin is
	 * called the "state location" and is usually in
	 * pathToWorkspace/.metadata/pluginName
	 *
	 * @param filename
	 *            Appended to the state location. This is the name of the resource
	 *            to be saved.
	 * @return path to location reserved for the plugin which can be used to store
	 *         resources
	 */
